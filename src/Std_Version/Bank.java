...
public class Bank {
    ...
    /**
     * Adds the given Account to the bank. If the bank is full
    ...
    public String toString() {
        ...
        for (int i = 0; i < firstAvailableAcc; i++) {
            ...
            // Note that we don't make use of Account's toString because
            // we don't want to have lira signs (₺) as part of the String
